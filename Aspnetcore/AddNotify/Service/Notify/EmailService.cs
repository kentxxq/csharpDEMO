...
namespace AddNotify.Service.Notify;
...
public class EmailService
{
    ...
    {
        var tuples = filesPath.Select(filePath => (filePath:Path.GetFileName(filePath), fileStream:new FileStream(filePath,FileMode.Open) as Stream)).ToList();
